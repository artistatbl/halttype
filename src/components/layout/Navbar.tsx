...
export function Navbar({ className }: NavbarProps) {
  return (
    <header className={cn(
      "w-full py-5 px-8 flex flex-wrap items-center justify-between bg-zinc-950/70 text-xs mt-6 mb-10 mx-auto max-w-[90%] rounded-xl shadow-md gap-y-4",
      className
    )}>
      <div className="w-full flex flex-wrap items-center justify-between gap-y-4">
        {/* Logo and Navigation */}
        <div className="flex items-center gap-4">
          <Link href="/" className="text-zinc-100 font-medium flex items-center gap-1 hover:text-emerald-400 hover:scale-105 transition-all duration-200">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <Link href="/leaderboard" className="text-zinc-500 hover:text-zinc-300 hover:scale-105 transition-all duration-200 flex items-center gap-1.5">
            ...
            <Link href="/about" className="text-zinc-500 hover:text-zinc-300 hover:scale-105 transition-all duration-200 flex items-center gap-1.5">

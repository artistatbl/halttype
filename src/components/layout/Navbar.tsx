...
export function Navbar({ className }: NavbarProps) {
  const isFocusMode = className?.includes('navbar-focus-mode') || false
  
  return (
    <header className={cn(
      "w-full py-5 px-8 flex flex-wrap items-center justify-between text-xs mt-6 mb-10 mx-auto max-w-[90%] gap-y-4 bg-background text-card-foreground transition-all duration-300",

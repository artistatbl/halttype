    ...
    <header className={cn(
      ...
      <div className="w-full flex flex-wrap items-center justify-between gap-y-4">
        ...
        <div className="flex items-center gap-4">
          <Link href="/" className="text-foreground font-medium flex items-center gap-1 hover:text-primary hover:scale-105 transition-all duration-200">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <Link href="/" className="text-muted-foreground hover:text-foreground hover:scale-105 transition-all duration-200 flex items-center gap-1.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 3a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3H6a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3V6a3 3 0 0 0-3-3 3 3 0 0 0-3 3 3 3 0 0 0 3 3h12a3 3 0 0 0 3-3 3 3 0 0 0-3-3z"></path></svg>
              <span>Practice</span>
            </Link>
            <Link href="/leaderboard" className="text-muted-foreground hover:text-foreground hover:scale-105 transition-all duration-200 flex items-center gap-1.5">
            ...
            <Link href="/about" className="text-muted-foreground hover:text-foreground hover:scale-105 transition-all duration-200 flex items-center gap-1.5">

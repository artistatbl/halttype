...
export function Footer({ className }: FooterProps) {
  ...
  return (
    <footer className={cn(
      "w-full py-4 px-6 flex items-center justify-between bg-zinc-950/80 backdrop-blur-sm text-sm",
      className
    )}>
      {/* Language Selection */}
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 text-zinc-600">

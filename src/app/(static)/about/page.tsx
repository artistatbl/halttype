        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              your typing skills. Whether you're a student, professional, or just someone looking to enhance 
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We believe that typing is a fundamental skill in today's digital world. Our mission is to 
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We respect your privacy. HaltType doesn't track personal information or store your typing 
